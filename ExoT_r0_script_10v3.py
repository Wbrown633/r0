# Script written for Hanfei wash optimization experiment
...
pumps.buzz(0)
print("w1: add 1.2 mL 1x PBS, then push 'ok'")
...
pumps.buzz(0)
print("w2: add 1.2 mL 1x PBS, then push 'ok'")

while True:
    if GPIO.input(Sw2) == 0:
        break
    
print("running 2nd PBS wash") 
print("Rate:", pumps.set_rate(-15, 'MH', addr))
print("Volume:", pumps.set_volume(1.2, 'ML',  addr))
print("Run:", pumps.run(addr))
...
while True:
    stat = pumps.status(addr)
    if stat == 'S':
        print("2nd PBS wash complete")
        break

###PBS wash 3

pumps.buzz(0)
print("w3: add 1.2 mL 1x PBS, then push 'ok'")

while True:
    if GPIO.input(Sw2) == 0:
        break
    
print("running 3rd PBS wash") 
print("Rate:", pumps.set_rate(-15, 'MH', addr))
print("Volume:", pumps.set_volume(1.2, 'ML',  addr))
print("Run:", pumps.run(addr))
...
while True:
    stat = pumps.status(addr)
    if stat == 'S':
        print("3rd PBS wash complete")
        break

###PBS wash 4

pumps.buzz(0)
print("w4: add 1.2 mL 1x PBS, then push 'ok'")

while True:
    if GPIO.input(Sw2) == 0:
        break
    
print("running 4th PBS wash") 
print("Rate:", pumps.set_rate(-15, 'MH', addr))
print("Volume:", pumps.set_volume(1.2, 'ML',  addr))
print("Run:", pumps.run(addr))
...
while True:
    stat = pumps.status(addr)
    if stat == 'S':
        print("4th PBS wash complete")
        break

###PBS wash 5

pumps.buzz(0)
print("w5: add 1.2 mL 1x PBS, then push 'ok'")

while True:
    if GPIO.input(Sw2) == 0:
        break
    
print("running 5th PBS wash") 
print("Rate:", pumps.set_rate(-15, 'MH', addr))
print("Volume:", pumps.set_volume(1.2, 'ML',  addr))
print("Run:", pumps.run(addr))
...
while True:
    stat = pumps.status(addr)
    if stat == 'S':
        print("5th PBS wash complete")
        break

###PBS wash 6

pumps.buzz(0)
print("w6: add 1.2 mL 1x PBS, then push 'ok'")

while True:
    if GPIO.input(Sw2) == 0:
        break
    
print("running 6th PBS wash") 
print("Rate:", pumps.set_rate(-15, 'MH', addr))
print("Volume:", pumps.set_volume(1.2, 'ML',  addr))
print("Run:", pumps.run(addr))
