...
# Script written for Erica Quant-it experiments
# orig from 2v0
# 1.9 mL F127
...
pumps.buzz(0)
print("add 1.9 mL F127, then push 'ok'")
...
pumps.buzz(0)
print("add 2.0 mL sample, then push 'ok'")
...
print("Volume:", pumps.set_volume(2.0, 'ML',  addr))
print("Run:", pumps.run(addr))
