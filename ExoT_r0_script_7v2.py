...
pumps.buzz(0)
print("add 1.25 mL F127, then push 'ok'")
...
print("Rate:", pumps.set_rate(-50, 'UH', addr))
print("Volume:", pumps.set_volume(0.05, 'ML',  addr))
print("Run:", pumps.run(addr))
...
pumps.buzz(0)
print("add 1.0 mL sample, then push 'ok'")
...
print("Volume:", pumps.set_volume(1.0, 'ML',  addr))
print("Run:", pumps.run(addr))
...
pumps.buzz(0)
print("add 1.0 mL 1x PBS, then push 'ok'")
